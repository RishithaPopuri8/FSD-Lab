      ...
      <table className="styled-table">
        <thead>
          <tr>
            ...
            <th style={{ border: '1px solid #3624ee', padding: '8px', textAlign: 'center', backgroundColor: 'lightblue' }}>Name</th>
          </tr>
        </thead>
        <tbody>
...
const App = () => {
  ...
  const handleFileUpload = (event) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      reader.onload = (e) => {
        ...
        setSelectedImages((prevSelectedImages) => [...prevSelectedImages, newImage]);
      };
  ...
  return (
    <div>
      ...
      <div className='watermark'>P.MENAJA</div>
    </div>
  );
};
